...
export default async function handler(_: Request, context: Context) {
  ...
  const html = `
        <div align="center">
          ...
          Cubic Music is a resource efficient audio streaming client for YouTube & YTMusic. <a style="text-decoration:underline;" target="_blank" href="https://github.com/n-ce/Cubic Music/wiki/usage">Learn more about how to use the application effectively.</a>
          <br><br>
          Our new primary domain is <a style="text-decoration: underline;font-weight: bold;" href="https://Cubic Music.pp.ua">https://Cubic Music.pp.ua</a>.
          PWA users can reinstall from here. Data can be migrated via settings/library import. Cubic Music.netlify.app remains active.
          <br><br>
        ${cgeo === 'IN' ?
