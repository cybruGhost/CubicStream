  ...
  return (
    <>
      <div>
        ...
        >
          <option value="https://Cubic Music.pp.ua">Cubic Music</option>
...
function exportSettings() {
  const link = $('a');
  link.download = 'Cubic Music_settings.json';
